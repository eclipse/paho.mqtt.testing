...
class SubscriptionEngines:
	...
	def setState(self, a):
		self.__subscriptions = copy.deepcopy(a.__subscriptions)
		self.__retained = copy.deepcopy(a.__retained)
		
		self.__dollar_subscriptions = copy.deepcopy(a.__dollar_subscriptions)
		self.__dollar_retained = copy.deepcopy(a.__dollar_retained)
		
	def __eq__(self, se):
		try:
			assert self.__subscriptions == se.__subscriptions
			assert self.__retained == se.__retained
			assert self.__dollar_subscriptions == se.__dollar_subscriptions
			assert self.__dollar_retained == se.__dollar_retained
			return True
		except:
			raise
			return False
